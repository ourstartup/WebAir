...
@SequenceGenerator(name = "SEQ_IOT_HCHC_RECORD_ID", sequenceName = "SEQ_IOT_HCHC_RECORD_ID", allocationSize = 1, initialValue = 1)
public class HCHCRecord implements Serializable
{
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IOT_HCHC_RECORD_ID")
    @Column(name = "DBID")
    public long getId()
    {
        return id;
