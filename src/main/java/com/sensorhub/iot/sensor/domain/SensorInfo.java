...
@SequenceGenerator(name = "SEQ_IOT_SENSOR_INFO_ID", sequenceName = "SEQ_IOT_SENSOR_INFO_ID", allocationSize = 1, initialValue = 1)
public class SensorInfo implements Serializable
{
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IOT_SENSOR_INFO_ID")
    @Column(name = "DBID")
    public long getId()
    {
        return id;
