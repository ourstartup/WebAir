...
@SequenceGenerator(name = "SEQ_IOT_SENSOR_TYPE_ID", sequenceName = "SEQ_IOT_SENSOR_TYPE_ID", allocationSize = 1, initialValue = 1)
public class SensorType implements Serializable
{
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IOT_SENSOR_TYPE_ID")
    @Column(name = "DBID")
    public long getId()
    {
        return id;
