...
@SequenceGenerator(name = "SEQ_IOT_DEVICE_TYPE_ID", sequenceName = "SEQ_IOT_DEVICE_TYPE_ID", allocationSize = 1, initialValue = 1)
public class DeviceType implements Serializable
{
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IOT_DEVICE_TYPE_ID")
    @Column(name = "DBID")
    public long getId()
    {
        return id;
