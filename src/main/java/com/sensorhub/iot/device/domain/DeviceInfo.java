...
@SequenceGenerator(name = "SEQ_IOT_DEVICE_INFO_ID", sequenceName = "SEQ_IOT_DEVICE_INFO_ID", allocationSize = 1, initialValue = 1)
public class DeviceInfo implements Serializable
{
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IOT_DEVICE_INFO_ID")
    @Column(name = "DBID")
    public long getId()
    {
        return id;
